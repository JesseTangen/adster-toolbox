...
const plugins = [
  ...
  tailwindcss(),
  jsxLocPlugin(),
  // The Manus runtime and file-backed debug collector only work inside the
  // managed Node preview. Omit them from the portable static Pages artifact.
  ...(isGitHubPagesBuild ? [] : [vitePluginManusRuntime(), vitePluginManusDebugCollector()]),
];
...
export default defineConfig({
  ...
  resolve: {
    alias: {
      ...
      "@adster/prompt-library": path.resolve(import.meta.dirname, "packages", "prompt-library", "src", "index.ts"),
