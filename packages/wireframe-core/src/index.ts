...
export const multiColumnContentStyles = [
  ...
  { id: "blog", label: "Blog", defaultTitle: "From the journal", itemLabel: "Post", media: ["image"], supportsReadMore: false, hasSummary: true, hasPrice: false, hasCart: false },
  ...
  { id: "product", label: "Product", defaultTitle: "Featured products", itemLabel: "Product", media: ["image"], supportsReadMore: false, hasSummary: false, hasPrice: true, hasCart: true },
] as const;
