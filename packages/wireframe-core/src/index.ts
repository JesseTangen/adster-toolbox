...
export const wireframeSectionDefinitions: WireframeSectionDefinition[] = [
  ...
  { type: "footer", label: "Footer", category: "Frame", description: "Closing navigation, contact routes, and legal detail.", defaultTitle: "Make the next step easy", variants: [{ id: "columns", label: "Link columns", description: "Classic multi-column footer." }, { id: "cta", label: "CTA footer", description: "Strong final action before links." }, { id: "minimal", label: "Minimal footer", description: "Small, low-friction legal treatment." }] },
];
