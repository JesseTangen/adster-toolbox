...
export default function WireframeBuilder() {
  ...
  return (
    <div className="mx-auto w-full max-w-[1600px] pb-10">
      ...
      <div className="mt-5"><SavedProjectsCard label="wireframes" projectNameLabel="Wireframe name" projects={projects} activeProjectId={activeProjectId} projectName={projectName} status={saveStatus} onSelect={openProject} onProjectNameChange={setProjectName} onNew={() => { void createProject(false); }} onDuplicate={() => { void createProject(true); }} onDelete={() => { void removeProject(); }} /></div>
