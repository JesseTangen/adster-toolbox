      ...
      <div className="relative" ref={sidebarRef}>
        ...
        >
          ...
          <SidebarFooter className="space-y-2 p-3 group-data-[collapsible=icon]:items-center group-data-[collapsible=icon]:p-2">
            <div className="flex items-center gap-3 rounded-xl border border-sidebar-border bg-sidebar-accent/45 px-2 py-2 group-data-[collapsible=icon]:h-9 group-data-[collapsible=icon]:w-9 group-data-[collapsible=icon]:justify-center group-data-[collapsible=icon]:rounded-full group-data-[collapsible=icon]:p-0">
            ...
            <button onClick={toggleTheme} role="switch" aria-checked={theme === "dark"} className="flex h-9 w-full items-center justify-between gap-2 rounded-lg border border-sidebar-border bg-sidebar-accent/30 px-2 text-[10px] font-medium text-muted-foreground transition hover:bg-sidebar-accent group-data-[collapsible=icon]:w-9 group-data-[collapsible=icon]:justify-center group-data-[collapsible=icon]:rounded-full group-data-[collapsible=icon]:p-0" aria-label="Toggle dark mode"><span className="flex items-center gap-2"><span className="relative flex h-4 w-7 items-center rounded-full bg-muted transition group-data-[collapsible=icon]:hidden"><span className={`h-3 w-3 rounded-full bg-primary transition-transform ${theme === "dark" ? "translate-x-3.5" : "translate-x-0.5"}`} /></span><span className="hidden group-data-[collapsible=icon]:block">{theme === "dark" ? <Sun className="h-3.5 w-3.5" /> : <Moon className="h-3.5 w-3.5" />}</span><span className="group-data-[collapsible=icon]:hidden">Dark mode</span></span></button>
          </SidebarFooter>
        </Sidebar>
        <div
